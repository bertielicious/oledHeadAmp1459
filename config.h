 ...
 * Author: Phil
 *
 * Created on 26 April 2018, 20:55
 */
...
volatile int time_out = 0;  // if time_out = 1, 85 ms has expired
...
/*SWIP STUFF*/
#define DT PORTAbits.RA1       // pin 18 interrupt on change 
#define CLK PORTAbits.RA4        // pin 3  interrupt on change
